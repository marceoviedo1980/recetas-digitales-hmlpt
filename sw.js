const CACHE_NAME = "recetario-digital-manual-20260528-87";
const APP_SHELL = [
  "./",
  "./index.html",
  "./index.html?app=pwa",
  "./styles.css?v=manual-20260528-87",
  "./app.js?v=manual-20260528-87",
  "./manifest.webmanifest?v=manual-20260528-87",
  "./icons/icon-32.png",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
  "./icons/icon-1024.png",
